...
class CodeFormatter(BaseFormatter):
    ...
    def validate_response(self, response: str) -> Tuple[bool, Dict[str, str]]:
        """
        ...
        try:
            ...
            # Simple validation - check if it's not empty and contains basic Python syntax
            if not code.strip():
                return False, {"error": "No code found in response"}
